...
public class EndlessTerrain : MonoBehaviour
{
    ...
    public class TerrainChunk
    {
        ...
        public TerrainChunk(Vector2 coord, int size, LODInfo[] detailsLevels, int colliderLODIndex, Transform parent, Material material)
        {
            this.coord = coord;
        ...
        public void UpdateCollisionMesh()
        {
            if (!hasSetCollider) { 
                ...
                if (sqrDistanceFromViewerToEdge < detailsLevels[colliderLODIndex].sqrVisibleDistanceThreshold)
                {
    ...
    {
        [Range(0,MeshGenerator.numSuppotedLOD-1)]
        public int lod;
